...
export class ProductRegistrationComponent implements OnInit {
  ...
  value2 : Boolean = false
    constructor(private messageservice:MessageService ,private router:Router,private companyservice:CompanyServiceService,private drugformationservice:DrugformationService,private productRegistrationservice:ProductRegistrationService) { }
  ...
  onchangeUnitPrice(){
    this.productRegistration.unitPrice=this.productRegistration.boxRate/this.productRegistration.packing;
...
saveproductregistrtion(){
 ...
 this.productRegistrationservice.postproductregistration(this.productRegistration).subscribe(
  data => {
